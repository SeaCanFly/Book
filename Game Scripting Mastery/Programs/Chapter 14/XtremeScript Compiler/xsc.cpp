/*
    ...
    Abstract.
        ...
        The framework for the XtremeScript compiler; implements all major structures and
        functions except the parser. Scripts can be hardcoded into the I-code module and tables
        to test it's abilities.
...
// ---- Functions -----------------------------------------------------------------------------
    ...
    */
    ...
    {
        /*
            For the purposes of chapter 14, this function will only serve the purpose of
            encapsulating our hardcoded script.
        */
...
// ---- Main ----------------------------------------------------------------------------------
    ...
    main ( int argc, char * argv [] )
    {
        ...
        /*
            ...
            to the I-code modules and tables without disturbance from other modules. Of course,
            this will all be vitally important in chapter 15, when the compiler actually
